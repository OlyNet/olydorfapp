package de.olynet.olydorfapp.inappbilling;
...
import de.olynet.olydorfapp.MainActivity;
import de.olynet.olydorfapp.R;

/**
 * Created by Simon on 10.04.2014.
 */
public class IabUtil {
    ...
    private IabUtil() {
        ...
        // TODO: populate with sellable items
        /*
    ...
    public static class PurchaseDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            // TODO: replace with the correct fragment
            View rootView = null; //layoutInflater.inflate(R.layout.demo_purchase_about, null);
            ...
            TextView nameAndVersionView = null;
                //(TextView) rootView.findViewById(R.id.purchase_app_name_and_version);
            ...
            final RelativeLayout lsmall = null;//(RelativeLayout) rootView.findViewById(R.id.purchase_small_layout);
            TextView lsmallText = null;//(TextView) rootView.findViewById(R.id.purchase_small_layout_text);
            lsmallText.setText(iabUtil.items.get(SMALL_BEER_SKU).nameId);
            TextView lsmallTextPrice = null;//(TextView) rootView.findViewById(R.id.purchase_small_layout_text_price);
            ...
            final RelativeLayout lmedium = null;//(RelativeLayout) rootView.findViewById(R.id.purchase_medium_layout);
            TextView lmediumText = (TextView) null;//rootView.findViewById(R.id.purchase_medium_layout_text);
            lmediumText.setText(iabUtil.items.get(MEDIUM_BEER_SKU).nameId);
            TextView lmediumTextPrice = null;//(TextView) rootView.findViewById(R.id.purchase_medium_layout_text_price);
            ...
            final RelativeLayout llarge = null;//(RelativeLayout) rootView.findViewById(R.id.purchase_large_layout);
            TextView llargeText = null;//(TextView) rootView.findViewById(R.id.purchase_large_layout_text);
            llargeText.setText(iabUtil.items.get(LARGE_BEER_SKU).nameId);
            TextView llargeTextPrice = null;//(TextView) rootView.findViewById(R.id.purchase_large_layout_text_price);
            ...
            final RelativeLayout lxlarge = null;//(RelativeLayout) rootView.findViewById(R.id.purchase_xlarge_layout);
            TextView lxlargeText = null;//(TextView) rootView.findViewById(R.id.purchase_xlarge_layout_text);
            lxlargeText.setText(iabUtil.items.get(XLARGE_BEER_SKU).nameId);
            TextView lxlargeTextPrice = null;//(TextView) rootView.findViewById(R.id.purchase_xlarge_layout_text_price);
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setView(rootView)
                    .setPositiveButton(null, //R.string.purchase_cancel,
